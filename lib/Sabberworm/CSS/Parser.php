	...
	private function parseColorValue() {
		...
		if ($this->comes('#')) {
			...
			if ($strlen === 3) {
				...
				$sValue = $sValue[0] . $sValue[0] . $sValue[1] . $sValue[1] . 
                                            $sValue[2] . $sValue[2]. $sValue[3] . $sValue[3];
                        ...
                        if($strlen == 8) {
                            ...
                            $aColor =   [
                                        'r' => new Size(intval($sValue[0] . $sValue[1], 16), null, true, $this->iLineNo), 
                                        ...
                                        'a' => new Size(intval($sValue[6] . $sValue[7], 16), null, true, $this->iLineNo)
                                    ];
