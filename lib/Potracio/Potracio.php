...
class Potracio{
  ...
  public function loadImageFromFile($file){
    ...
    $this->loadImageFromResource(imagecreatefromstring(file_get_contents($file)));
  }

  public function loadImageFromResource( $image) {
  ...
  public function getSVG($size, $opt_type='') {
    ...
    if ($opt_type === "curve") {
      $strokec = $this->info->fill;
      $fillc = "none";
      $fillrule = '';
    } else {
      $strokec = "none";
      $fillc = $this->info->fill;
