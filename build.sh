...
uglifyjs --compress unsafe=true,passes=3,ecma=8,toplevel=true,unsafe_comps=true,unsafe_proto=true,warnings=true --warn --mangle  -- ../dist/sync.fallback.js > ../dist/sync.fallback.min.js
#
#
cd ./worker/src
#
