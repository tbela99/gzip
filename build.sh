...
../node_modules/rollup/bin/rollup ./lib/lib.ready.js -f iife --name=LIB > ./dist/lib.ready.js
../node_modules/rollup/bin/rollup ./lib/index.images.js -f iife --name=LIB > ./dist/lib.images.js
