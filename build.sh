...
#./localforage-all.js
#----- uglifyjs --compress unsafe=true,passes=3,ecma=8,toplevel=true,unsafe_comps=true,unsafe_proto=true,warnings=true --warn --mangle  -- ./dist/bundle.js > ./dist/bundle.min.js
