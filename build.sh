...
#
#
uglifyjs  --ecma=8 --compress passes=3,unsafe_proto=true,warnings=true,pure_funcs=["console.log","console.info","debug_js_window"]\
...
./node_modules/rollup/bin/rollup -f umd -n gzip worker/src/index.js > worker/dist/serviceworker.js
#
#
./node_modules/rollup/bin/rollup -f iife -- worker/src/sync/sw.sync.fallback.js | uglifyjs --warn --comments all --beautify beautify=true,preamble='"/* do not edit this file! */"' > worker/dist/sync.fallback.js
#| node ../../node_modules/browserify/bin/cmd.js -t babelify > ../dist/sync.fallback.js
uglifyjs --compress unsafe=true,passes=3,ecma=8,toplevel=true,unsafe_comps=true,unsafe_proto=true,warnings=true --warn --mangle  -- worker/dist/sync.fallback.js > worker/dist/sync.fallback.min.js
#
#
cd ./worker/src
#
...
#
#
uglifyjs --ecma=8 --compress passes=3,toplevel=true,unsafe_comps=true,unsafe_proto=true,warnings=true,pure_funcs=["console.log","console.info","debug_js_window"]\
